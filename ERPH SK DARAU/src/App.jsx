...
const firebaseConfig = {
  // PENTING: Untuk VS Code & Vercel, buang simbol komen (//) pada baris import.meta.env di bawah
  // dan padam baris apiKey: "API_KEY_SEMENTARA",
  // apiKey: import.meta.env.VITE_GOOGLE_API_KEY,
  
  apiKey: "import.meta.env.VITE_GOOGLE_API_KEY", // TUKAR BAHAGIAN INI NANTI
...
function TeacherPortal({ user, profile }) {
  ...
  const handleDeleteSubmission = async () => {
    try { await deleteDoc(doc(db, DB_COLLECTION, `${profile.id}_w${selectedWeek}`)); } catch (e) { console.error("Gagal memadam", e); }
  };
